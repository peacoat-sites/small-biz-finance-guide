---
title: "OSHA Requirements for Small Business: Essential Compliance Guide"
date: 2026-08-10T22:19:33.661771+00:00
draft: false
description: "Learn OSHA's key requirements for small businesses, including workplace safety standards, recordkeeping, inspections, and how to stay compliant."
image: "/img/heroes/6791487.jpg"
categories: ["HR"]
tags: ["osha", "requirements", "small", "business"]
...
slug: "osha-requirements-small-business"
affiliate_disclosure: true
faqs:
  - q: "Does OSHA apply to businesses with only one or two employees?"
    a: "Yes. OSHA covers private sector employers with even one employee. Size affects certain recordkeeping thresholds, but the General Duty Clause and most specific safety standards apply regardless of headcount."
  - q: "What's the difference between a serious and an other-than-serious OSHA violation?"
    a: "A serious violation is one where there's substantial probability that death or serious physical harm could result, even if the employer didn't intend harm. An other-than-serious violation involves a hazard with less severe potential outcomes. Penalties differ: serious violations currently carry up to $16,131 per violation; other-than-serious violations carry the same ceiling but are typically penalized much lower in practice."
  - q: "Can an employee file an anonymous OSHA complaint?"
    a: "Employees can request that their identity not be disclosed to the employer. OSHA will attempt to keep the complainant's name confidential, but in small workplaces with few employees, it can be difficult to maintain that anonymity in practice."
  - q: "How long do I have to fix an OSHA citation?"
    a: "The citation itself specifies an 'abatement date,' which is the deadline to correct the hazard. You can contest the citation or request an informal conference with OSHA to negotiate the abatement period or penalty amount. Missing an abatement deadline triggers additional 'failure to abate' penalties, which are steeper than the original fine."
  - q: "What industries are exempt from OSHA?"
    a: "Self-employed individuals with no employees, certain family farms, and workplaces regulated by other federal agencies (like mines covered by MSHA) are generally outside OSHA's jurisdiction. State and local government employees aren't covered by federal OSHA, but most states have their own OSHA-approved plans that cover public sector workers. Always verify with a qualified employment attorney if you're unsure about your specific situation."
---

Most [small business owners](/sba-loans-now-require-100-us-citizenship-what-small-business-owners-mu/) I talk to think OSHA is something that only matters once you hit a certain size, like there's some magic headcount threshold where the safety police start paying attention. That's wrong, and it's the kind of wrong that can cost you real money.
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">OSHA covers nearly all private employers with at least one employee, regardless of business size.</li><li style="margin:5px 0">Businesses with 10 or fewer employees are partially exempt from injury/illness recordkeeping, but NOT from safety standards.</li><li style="margin:5px 0">First-time violations for serious citations currently run up to $16,131 per violation (as of 2026).</li><li style="margin:5px 0">The free OSHA On-Site Consultation Program visits your workplace confidentially, with no citations issued.</li><li style="margin:5px 0">Posting the OSHA "It's the Law" poster is mandatory and free to download at osha.gov.</li></ul></div>
...
The specific standards that apply to your business depend on your industry. OSHA organizes requirements into four main sectors: General Industry (the catch-all), Construction, Maritime, and Agriculture. [Most small businesses](/the-obbba-childcare-credit-most-small-businesses-are-ignoring/) fall under General Industry, Title 29 CFR Part 1910. Within that, the standards most likely to trip up small employers are:
...
Here's where size actually does matter, a little. Employers with 10 or fewer employees are partially exempt from OSHA's injury and illness recordkeeping requirements, meaning you don't have to maintain OSHA 300 logs. But there's a catch most people miss: you still have to report certain severe injuries to OSHA directly, regardless of size.

As of 2026, the reporting requirements are:

| Event | Reporting Deadline | How to Report |
|---|---|---|
| Work-related fatality | 8 hours | Call 1-800-321-OSHA or online |
| In-patient hospitalization (1+ employee) | 24 hours | Call 1-800-321-OSHA or online |
| Amputation | 24 hours | Call 1-800-321-OSHA or online |
| Loss of an eye | 24 hours | Call 1-800-321-OSHA or online |
...
Landscaping company, 14 employees, no PPE documentation → OSHA complaint filed by former worker → two serious citations for lack of written PPE program and no eye/face protection training records → $7,400 in penalties, reduced to $5,200 after good-faith abatement demonstration.

Bakery, 7 employees → voluntary OSHA consultation requested → inspector identified chemical storage issue with cleaning agents (no SDS, no secondary labels) → fixed in 30 days at a cost of roughly $340 in supplies and two hours of staff training → zero penalties, consultation closed.

Small manufacturing shop, 22 employees → annual 300 log not posted in February → programmed inspection happened to occur in March → other-than-serious citation for posting violation, $1,087 penalty → pain that was entirely avoidable.
...
- [OSHA Small Business Resources](https://www.osha.gov/smallbusiness): Official guidance, free tools, and industry-specific resources from the Occupational Safety and Health Administration.
- [OSHA Penalty Adjustments (2026)](https://www.osha.gov/penalties): Current civil penalty amounts adjusted for inflation, updated annually.
- [OSHA On-Site Consultation Program](https://www.osha.gov/consultation): State-by-state directory of free, confidential workplace safety consultations.
- [SCORE Small Business Compliance Guides](https://www.score.org): Free mentorship resources including regulatory compliance overviews for small employers.
- [29 CFR Part 1904: Recording and Reporting Occupational Injuries and Illnesses](https://www.ecfr.gov/current/title-29/subtitle-B/chapter-XVII/part-1904): The actual federal regulation governing OSHA recordkeeping requirements.
