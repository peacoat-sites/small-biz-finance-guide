---
title: "Solo 401k vs SEP IRA: Which Saves Small Owners More"
date: 2026-07-19T22:33:47.110054+00:00
draft: false
description: "Compare solo 401k and SEP IRA retirement plans for self-employed business owners. See contribution limits, tax benefits, and which fits your needs."
image: "/img/heroes/7545329.jpg"
categories: ["Benefits"]
tags: ["best", "retirement", "plan", "small", "business"]
...
slug: "best-retirement-plan-for-small-business-owner-solo-401k-vs-sep-ira"
affiliate_disclosure: true
faqs:
  - q: "Can I have both a Solo 401(k) and a SEP-IRA at the same time?"
    a: "Technically yes, but in practice it rarely makes sense and the contribution limits apply across all plans combined. You'd still be capped at the same $70,000 total. Talk to a CPA before trying to run both."
  - q: "What if I have a day job with a 401(k) and also do freelance work?"
    a: "Your employee deferral limit ($23,500 in 2026) is per person, not per plan. So if you're maxing a 401(k) at your W-2 job, you can't double-dip that $23,500 into a Solo 401(k). You can, however, still make the employer-side contribution to a Solo 401(k) based on your self-employment income."
  - q: "Is a Solo 401(k) worth it if I only make $40,000 in self-employment income?"
    a: "Yes, possibly. At $40,000 net SE income, a SEP lets you contribute roughly $7,300. A Solo 401(k) lets you contribute up to $23,500 (employee deferral alone). The math still favors the Solo 401(k) if you have that cash to put away."
  - q: "Does my spouse count as an employee for Solo 401(k) eligibility?"
    a: "No. A spouse who works in the business can actually participate in the Solo 401(k) as well, which can double the household's contribution room. This is one of the most underused features of the Solo 401(k) for couples running a business together."
  - q: "When is the deadline to contribute to a Solo 401(k) vs. a SEP-IRA?"
    a: "The Solo 401(k) must be established by December 31 of the tax year. Contributions can be made up to your tax filing deadline (plus extensions). SEP-IRA can be both opened and funded up to the tax filing deadline including extensions, usually October 15 for sole proprietors."
---

Only 13% of self-employed Americans have any retirement savings at all. That number stopped me cold the first time I saw it, because I work with [small business owners](/sba-loans-now-require-100-us-citizenship-what-small-business-owners-mu/) every day and I still wasn't prepared for how stark it was. Most of them are pouring every dollar back into the business, telling themselves they'll "figure out retirement later." Later has a way of never arriving.
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">Solo 401(k) allows up to $70,000 in contributions in 2026 vs. SEP-IRA's same cap, but Solo 401k reaches it at a lower income level.</li><li style="margin:5px 0">SEP-IRA contributions are limited to 25% of net self-employment income; Solo 401(k) adds an employee elective deferral of up to $23,500 on top.</li><li style="margin:5px 0">Solo 401(k) allows Roth contributions and loans; SEP-IRA does not.</li><li style="margin:5px 0">SEP-IRA wins on simplicity: open it in 20 minutes, no annual IRS filing until assets exceed $250,000.</li><li style="margin:5px 0">If you have any W-2 employees (non-spouse), Solo 401(k) eligibility disappears immediately.</li></ul></div>
...
A SEP-IRA works on one lever: employer contributions only. The IRS caps those at 25% of net self-employment income (after the deduction for half of self-[employment tax](/schedule-se-self-employment-tax/)). So if your net SE income is $120,000, your maximum SEP contribution is roughly $27,500. Not bad. But nowhere near the $70,000 ceiling.
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Max Solo 401(k) vs. SEP-IRA contribution by net SE income (2026)</div><div class="sc-row"><span class="sc-label">$60K income</span><span class="sc-track"><span class="sc-bar" style="width:34%"></span></span><span class="sc-val">$23,500</span></div><div class="sc-row"><span class="sc-label">$100K income</span><span class="sc-track"><span class="sc-bar" style="width:59%"></span></span><span class="sc-val">$41,000</span></div><div class="sc-row"><span class="sc-label">$150K income</span><span class="sc-track"><span class="sc-bar" style="width:79%"></span></span><span class="sc-val">$55,000</span></div><div class="sc-row"><span class="sc-label">$200K income</span><span class="sc-track"><span class="sc-bar" style="width:97%"></span></span><span class="sc-val">$68,000</span></div><div class="sc-row"><span class="sc-label">$250K+ income</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">$70,000</span></div><div class="sc-src">Source: IRS Publication 560, 2026 limits</div></div>
...
| Eligible if you have employees | No (spouse only) | Yes |
| Setup deadline | December 31 of tax year | Tax filing deadline + extensions |
| Annual IRS filing (Form 5500-EZ) | Required when assets exceed $250,000 | Not required |
| Setup complexity | Moderate (plan document required) | Very easy |
| Investment flexibility | Depends on custodian | Depends on custodian |
| Contribution deadline | Employee portion by Dec 31; employer by tax deadline | Tax filing deadline + extensions |
...
Here's a worked example that I've replicated in various forms with actual clients:
...
The IRS lays out the self-employed contribution limits clearly in [Publication 560](https://www.irs.gov/pub/irs-pdf/p560.pdf), and I'd actually recommend reading it, or at least having your CPA walk through it with you. It's more readable than most IRS documents, which I realize is a low bar.

## Where the SEP-IRA Still Makes Sense

Don't dismiss it. For some [business owners](/the-new-1099-thresholds-small-business-owners-must-know-in-2026/), the SEP is exactly right.
...
SEP-IRA contribution: approximately $69,000 (near max).
Solo 401(k) contribution: $70,000 plus $7,500 catch-up = $77,500.
...
This is worth thinking about before you get attached to the Solo 401(k). The [U.S. Small Business Administration](https://www.sba.gov/) has resources on business growth planning, but they don't always connect the dots to how hiring affects your retirement plan eligibility. That gap is where business owners get caught.
...
- [IRS Publication 560, Retirement Plans for Small Business (2026)](https://www.irs.gov/pub/irs-pdf/p560.pdf): Official IRS guidance on SEP, SIMPLE, and qualified plans for self-employed individuals, including current contribution limits.
- [IRS Self-Employed Individuals Tax Center](https://www.irs.gov/businesses/small-businesses-self-employed/self-employed-individuals-tax-center): IRS guidance hub for sole proprietors and single-member LLCs covering retirement deductions and plan types.
- [U.S. Small Business Administration: Retirement Plans](https://www.sba.gov/business-guide/manage-your-business/retirement-plans): SBA overview of retirement plan options for small business owners.
- EBRI (Employee Benefit Research Institute) 2025 Retirement Confidence Survey: Data on self-employed retirement savings rates and participation gaps, including the 13% statistic on self-employed workers with active retirement savings.
- [IRS Form 5500-EZ Instructions (2026)](https://www.irs.gov/forms-pubs/about-form-5500-ez): Required annual filing for Solo 401(k) plans when plan assets exceed $250,000.
...
If you want to go deeper on the mechanics before talking to a CPA, Mike Piper's *[Taxes Made Simple](https://www.amazon.com/Taxes-Made-Simple-Income-Straight/dp/0997061855?tag=)* (Amazon, affiliate link) covers self-employment tax and retirement deductions in plain language better than anything else I've found at that price point. It's $12 and worth every dollar.
