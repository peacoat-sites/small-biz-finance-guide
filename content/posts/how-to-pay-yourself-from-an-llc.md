---
title: "How to Pay Yourself From an LLC: 5 Methods Explained"
date: 2026-07-10T22:40:17.279972+00:00
draft: false
...
faqs:
  - q: "Can I pay myself a salary from a single-member LLC?"
    a: "Not in the traditional payroll sense, unless your LLC has elected S-corp or C-corp tax treatment. With a default single-member LLC, you take owner's draws, not a W-2 salary. Setting up payroll for yourself in a default single-member LLC is unnecessary, creates paperwork, and doesn't change your tax treatment."
  - q: "How often can I pay myself from my LLC?"
    a: "As often as you want. Weekly, biweekly, once a month, there's no legal requirement for a schedule on owner's draws. Most small business owners do better with a regular schedule rather than 'whenever,' because it forces them to think about cash flow before transferring money rather than after."
  - q: "Do owner's draws count as income for loan applications?"
    a: "It depends on the lender and the loan type. Most lenders look at your Schedule C net profit (for default single-member LLCs) or your K-1 income to assess your actual earnings, not just the draws you took. Some lenders will average your last two years of tax returns. This is why keeping your business income as clean as possible matters even when it's a solo operation."
  - q: "What's a 'reasonable salary' if I elect S-corp status?"
    a: "There's no IRS-published number, and that's intentional, it's supposed to reflect what you'd pay a third party to do the same work in your industry and location. Resources like the Bureau of Labor Statistics Occupational Employment Statistics, industry salary surveys, or a conversation with your CPA are the most defensible starting points. Setting your salary at $25,000 when you're running a $400,000 revenue business is the kind of thing that gets flagged."
  - q: "Do I need a separate business bank account to pay myself from an LLC?"
    a: "You don't legally need one in most states, but operating without one is genuinely risky. Mixing personal and business funds -- 'commingling' is the legal term, is one of the main ways the liability protection of an LLC gets pierced in court. A separate account also makes bookkeeping infinitely cleaner and makes it possible to actually document owner's draws. Open one. It takes 20 minutes and usually costs nothing at an online bank like Relay or Mercury."
---
...
| Structure | How You Pay Yourself | Payroll Required? | Self-Employment Tax | Admin Complexity |
|---|---|---|---|---|
| Single-member LLC (default) | Owner's draw (transfer money) | No | On all net profit | Low |
| Multi-member LLC (default) | Guaranteed payments or draws | No | On guaranteed payments + share of profit | Low-Medium |
| LLC taxed as S-corp | W-2 salary + distributions | Yes | On W-2 salary only | Medium-High |
| LLC taxed as C-corp | W-2 salary + dividends | Yes | On W-2 salary only | High |
...
- [IRS Publication 535 (Business Expenses)](https://www.irs.gov/publications/p535): Covers deductibility rules for business income and how owner's draws work under pass-through taxation.
- [IRS Schedule SE (Self-Employment Tax)](https://www.irs.gov/forms-pubs/about-schedule-se-form-1040): The actual form and instructions that govern SE tax calculations for LLC owners.
- [U.S. Small Business Administration (SBA)](https://www.sba.gov/): Plain-language guidance on business structures, estimated taxes, and self-employment tax obligations.
- [IRS Publication 505 (Tax Withholding and Estimated Tax)](https://www.irs.gov/publications/p505): The definitive guide for calculating and paying quarterly estimated taxes.
- [IRS Form 2553](https://www.irs.gov/forms-pubs/about-form-2553): Election by a Small Business Corporation, the form required to elect S-corp tax treatment for your LLC.
