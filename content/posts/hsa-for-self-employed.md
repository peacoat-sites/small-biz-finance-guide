...
I keep a simple spreadsheet tracking every out-of-pocket medical expense with the date, amount, and provider. When I eventually need a large tax-free withdrawal, the documentation is there. A book like [The White Coat Investor](https://www.amazon.com/White-Coat-Investor-Doctors-Finance/dp/0991433106?tag=contentportfo-20) (Amazon, may earn commission) covers this strategy in detail, mostly for physicians but the mechanics apply to anyone with a high income and the ability to cash-flow medical expenses.
