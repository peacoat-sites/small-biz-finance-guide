...
I'll be honest -- I didn't expect this to be such a widespread problem when I started consulting. I assumed owners were hiding from the P&L out of anxiety. What I found was simpler and sadder. Nobody ever walked them through it in plain language.
...
What surprises a lot of owners is what the P&L does *not* show: cash. This trips people up badly. You can show a profit on paper and be overdrawn. You can show a loss and have cash in the bank. That sounds paradoxical, but it's completely normal, and it happens because of timing differences (when you invoice vs. when you get paid), loan repayments, and capital purchases that don't hit the P&L the same way they hit your bank account. If you've ever thought "the numbers say I'm profitable but I'm broke," the answer almost always lives in the difference between your P&L and your cash flow statement.

The P&L is one of three core financial statements. The other two are the balance sheet and the cash flow statement. They're related, but they answer different questions. The P&L answers: did this business make money during this period?
...
Here's where I want to slow down, because the structure of a P&L is logical once you see it as a series of subtractions. Let's go top to bottom.

**Revenue (also called Sales or Income)**

This is the top line: all the money your business earned from selling its product or service during the period. Not money you received. Money you *earned*. If you sent a $5,000 invoice in December and got paid in January, under accrual accounting that $5,000 shows up in December's P&L. Under cash-basis accounting, it shows up in January. Knowing which method your bookkeeper uses matters enormously when you're reading these numbers.

Some P&Ls will show you gross revenue and then subtract returns or allowances to get to net revenue. If you do any volume of refunds or discounts, watch that line carefully. I've seen businesses hemorrhage margin through discounting that they never consciously tracked.

**Cost of Goods Sold (COGS)**

Subtract COGS from revenue and you get your gross profit. COGS includes only the direct costs of producing whatever you sell: raw materials, direct labor, manufacturing costs, or for a service business, subcontractor fees directly tied to delivery. What it does *not* include: your rent, your marketing spend, your own salary as owner. Those come later.

This distinction matters because your gross profit margin (gross profit divided by revenue, expressed as a percentage) is one of the most revealing numbers in any business. A 60% gross margin means you keep $0.60 of every revenue dollar before overhead. A 20% gross margin means you're starting the overhead race already tired. Industry benchmarks vary wildly. A software company might run 80% gross margins. A restaurant might scrape 30%. [The IRS small business tax center](https://www.irs.gov/businesses/small-businesses-self-employed) has general guidance on how COGS should be categorized, which is worth bookmarking if you're ever unsure how to classify an expense.
...
This section of the P&L is where I see the slow bleeds hide. A $200 software subscription you forgot about. A marketing spend that doubled quietly over 18 months. These things don't announce themselves. You have to look at the line items, not just the total. I'd encourage you to review every operating expense line at least quarterly and ask: do I still need this, and is it still priced right?

Subtract your operating expenses from gross profit and you get **operating income** (or operating profit, or EBIT -- earnings before interest and taxes). This is the number that best reflects how well the core business runs, before financing decisions and tax strategy muddy the picture.
...
Net income is the number everyone wants to know. It's also the most misleading number on the page if you look at it in isolation. A business can have strong net income while its operating income is weak, simply because it has a low-interest loan and a good accountant. Or it can have thin net income while the operations are actually performing well, because of aggressive growth spending. Always trace your way down the statement rather than jumping to the bottom.

---

## The Numbers That Actually Tell You Something

Reading a P&L isn't about memorizing line items. It's about developing a few specific habits.

Compare periods. A single P&L tells you almost nothing. Two or three laid side by side tell you a story. Is revenue growing? Great. Is COGS growing faster than revenue? Problem. Are operating expenses flat even as revenue scales? That's the leverage every small business owner should be chasing.

Calculate your gross margin every single period and write it down. If you run a product business and your gross margin drops two points quarter over quarter, that's a conversation to have with your supplier, your pricing, or your production process. Two points feels small. On $800,000 in revenue, it's $16,000.

Watch the ratio of operating expenses to revenue. This is sometimes called the operating expense ratio. If it's creeping up over time while revenue is flat, the business is getting less efficient. Simple as that.

What surprised me, when I started working with owners who had really mastered their P&L, was how quickly they could identify trouble before it became a crisis. They weren't financial wizards. They just read the same report consistently and compared it to last month, and last year, and their own internal benchmarks. Repetition builds pattern recognition. You can't fake that with a one-time review.

If you're looking to go deeper on the analytical side, Mike Michalowicz's *Profit First* (available [on Amazon](https://www.amazon.com/Profit-First-Transform-Cash-Eating-Money-Making/dp/073521414X), and yes, the site may earn a commission) is a good complement to traditional P&L analysis -- it reframes how you think about margin allocation entirely. It won't teach you to read a P&L per se, but it'll make you care about the gross margin line in a visceral way.
...
If you're an S-corp, you're required to pay yourself a "reasonable salary," which does show up as payroll expense. But if you're a sole prop and you're evaluating your business's true profitability, you need to ask: what would I have to pay someone to do what I do? Add that number as a hypothetical expense and see what the profit picture looks like. I've watched more than a few business owners decide to close or restructure after doing this exercise honestly for the first time.

SCORE (their mentorship resources are free at [score.org](https://www.score.org/)) has volunteer mentors who can actually sit down with you and go through your P&L line by line. Genuinely underused resource. I've referred clients there when they needed more hand-holding than I could provide on retainer.

And please, for anything touching taxes -- how to categorize expenses, how to treat depreciation, what counts as COGS -- get a CPA involved. The P&L you use for internal decision-making can be structured pretty loosely. The one that informs your tax return cannot.
...
The P&L isn't the enemy. It's just a report. And once you understand what it's actually measuring and where the traps are, it stops being intimidating and starts being the most useful 15 minutes you spend on your business each month.
