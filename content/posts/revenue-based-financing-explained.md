---
title: "$120K Business? Why Revenue-Based Financing Might Work"
date: 2026-08-09T22:04:08.788337+00:00
draft: false
description: "Learn how revenue-based financing works for growing businesses. Understand the terms, costs, and when RBF makes sense for your company."
image: "/img/heroes/33175651.jpg"
categories: ["Financing"]
tags: ["revenue-based", "financing", "explained"]
author: "David Kim"
...
faqs:
  - q: "Does revenue-based financing affect my credit score?"
    a: "Most RBF providers do a soft pull during underwriting, which doesn't impact your score. However, some will do a hard pull at final approval, so ask upfront. Defaulting on an RBF agreement can absolutely affect your credit if the lender reports to bureaus or pursues collections."
  - q: "Can I pay off an RBF advance early?"
    a: "Yes, but the economics don't reward you the way early loan payoff does. You'll still owe the full factor amount, so paying early just means a higher effective APR. Some lenders offer a small prepayment discount, usually 5–10% off the remaining balance, but it's not standard. Ask about it before you sign."
  - q: "What revenue level do I need to qualify?"
    a: "Most reputable RBF lenders want to see at least $10,000–$15,000 in monthly revenue for a minimum of six consecutive months. Clearco currently requires $10K/month minimum; Capchase and Arc tend to skew toward higher-revenue SaaS businesses. The advance amount is typically 2–5x your average monthly revenue, though some lenders go higher for strong performers."
  - q: "Is RBF the same as a merchant cash advance?"
    a: "Legally and structurally, they're related but not identical. A merchant cash advance is technically a purchase of future receivables; a true revenue-based financing agreement is a loan with revenue-linked repayments. The practical difference is cost (MCAs are almost always more expensive), repayment cadence (MCAs often pull daily), and the legal framework if things go wrong. Some providers use the RBF label loosely. Always read the term sheet."
  - q: "Do I need a business plan to apply?"
    a: "Not a formal one. RBF underwriting is revenue-forward: lenders care about your trailing revenue data, not a five-year projection deck. You'll typically need to explain what you're using the capital for and show how your revenue is generated, but nothing resembling an SBA loan application package. It's genuinely one of the faster, lighter documentation processes in small business lending."
---

Forty-three percent of [small business owners](/the-new-1099-thresholds-small-business-owners-must-know-in-2026/) who were denied a bank loan in the past two years say they didn't even know revenue-based financing existed as an option. That number comes from a 2025 Biz2Credit Small Business Credit Survey, and honestly, it doesn't surprise me. I've spent the better part of two decades helping business owners stitch together funding, and RBF is still the thing I have to explain from scratch almost every time.
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">RBF repayment is a fixed % of monthly revenue (typically 2–8%), not a fixed dollar amount.</li><li style="margin:5px 0">Total repayment is a "factor rate" on the original advance, usually 1.2x–1.5x (meaning $100K becomes $120K–$150K owed).</li><li style="margin:5px 0">Approval is based on revenue history, not credit score or collateral; many lenders want 6+ months of $10K+/month in revenue.</li><li style="margin:5px 0">RBF works best for businesses with predictable, recurring revenue ,  SaaS, e-commerce, subscription services.</li><li style="margin:5px 0">Effective APR can exceed 40–80% annualized. Run the numbers before you sign.</li></ul></div>
...
This is the part that honestly caught me off guard the first time I modeled it for a client. The fixed repayment amount feels psychologically safe ("I know exactly what I owe"), but it obscures the actual cost of capital. A $100K advance at a 1.35 factor rate, repaid over 18 months, works out to an effective APR somewhere around 55–65% depending on your remittance schedule. That's not predatory by RBF standards, but it's nothing like the 7–9% you'd see on an [SBA loan](/sba-7a-loan-explained/). The Consumer Financial Protection Bureau has flagged the lack of standardized APR disclosure in the alternative lending space as a transparency gap, and in my experience, that gap is real.


<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Effective APR by repayment speed (1.35x factor, $100K advance)</div><div class="sc-row"><span class="sc-label">12 months</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">78%</span></div><div class="sc-row"><span class="sc-label">18 months</span><span class="sc-track"><span class="sc-bar" style="width:74%"></span></span><span class="sc-val">58%</span></div><div class="sc-row"><span class="sc-label">24 months</span><span class="sc-track"><span class="sc-bar" style="width:54%"></span></span><span class="sc-val">42%</span></div><div class="sc-row"><span class="sc-label">30 months</span><span class="sc-track"><span class="sc-bar" style="width:42%"></span></span><span class="sc-val">33%</span></div><div class="sc-row"><span class="sc-label">36 months</span><span class="sc-track"><span class="sc-bar" style="width:35%"></span></span><span class="sc-val">27%</span></div><div class="sc-src">Source: CFO estimate based on standard RBF terms, August 2026</div></div>
...
I'll be direct here: RBF is a solid tool for a specific type of business. It's not a universal fix.
...
- [Biz2Credit Small Business Credit Survey (2025)](https://www.biz2credit.com): Annual survey tracking small business loan approval rates and awareness of funding options across U.S. markets.
- [Consumer Financial Protection Bureau (CFPB) Small Business Resources](https://www.consumerfinance.gov/): Federal agency covering transparency gaps in alternative lending disclosures, including factor rate vs. APR reporting.
- [SCORE Small Business Mentorship Resources](https://www.score.org/): Free mentorship network for small business owners navigating financing decisions; volunteers with banking and lending backgrounds.
- [Federal Reserve Bank of New York: Small Business Credit Survey (2025)](https://www.newyorkfed.org/smallbusiness): Annual national survey covering small business financing outcomes, denial rates, and alternative lending usage.
