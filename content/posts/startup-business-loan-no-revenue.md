...
date: 2026-05-29T22:01:44.939049+00:00
draft: false
...
## Building a Lender-Ready Package With No Revenue
...
|---|---|
| APR (not just interest rate) | Get the full annualized cost including fees |
| Origination fees | Anything above 3-5% deserves scrutiny |
| Prepayment penalties | Avoid if you expect early repayment |
| Personal guarantee required | Almost always yes; know what you're signing |
| Collateral pledged | Understand exactly what you could lose |
| Reporting requirements | Some lenders require financial updates quarterly |
| Time to funding | Relevant if you have a cash timing need |

Always compare APR, not the monthly payment. A lower monthly payment stretched over a longer term can cost significantly more total. Ask every lender for the total repayment amount, not just the rate.
