...
This is where people get into trouble. The IRS definition of business use is specific, and it doesn't include everything you might assume.

**Qualifying business miles:**
- Driving to meet a client or customer
- Traveling between two business locations
- Driving to a supplier, vendor, or bank for business purposes
- Business-related travel to conferences, training, or temporary work locations

**What does NOT count:**
- Commuting from your home to your regular place of business. This is the one that surprises people most. Even if you own the business, driving from your house to your shop or office every morning is commuting, not business use.
- Personal errands, even if you run them in your "business" truck
- Driving to meals that don't have a legitimate business purpose
...
You can claim every deduction above and still lose them if you're audited and can't produce documentation. The IRS doesn't accept "I drove a lot for work." They want a mileage log.

A compliant mileage log includes, for each trip:
- The date
- The destination (address or business name)
...
One practical consideration: if you're deciding between buying and leasing a vehicle for business use, the buy-vs-lease decision involves cash flow, total cost of ownership, and tax treatment. Reviewing a resource like [*Tax Savvy for Small Business* by Frederick Daily](https://www.amazon.com/s?k=tax+savvy+for+small+business+frederick+daily) (Amazon affiliate link, this site may earn a commission) can help you understand the full picture before making that call.

## How Vehicle Deductions Interact With Your Business Structure

Your business structure affects how you claim vehicle expenses. Sole proprietors and single-member LLCs filing as disregarded entities report vehicle deductions on Schedule C. S-corp owners who use a personal vehicle for business and get reimbursed by their corporation use an accountable plan, and the reimbursement is not taxable income to the employee-owner as long as it's properly documented.

If you're uncertain how your entity structure affects your tax obligations overall, the comparison of [LLC vs. sole proprietorship taxes](/llc-vs-sole-proprietorship-taxes/) lays out the key differences in a practical way.

Partnership arrangements are more complex. Each partner's vehicle situation may be handled differently depending on whether the partnership owns the vehicle or the individual does. This is genuinely an area where a CPA earns their fee.

One thing that holds across all structures: mixing personal and business finances creates problems that go beyond taxes. If you're running business expenses through personal accounts or vice versa, you're making your books harder to reconcile and undermining your financial credibility. Getting the basics of [how to separate business and personal finances](/how-to-separate-business-personal-finances/) right protects you in more ways than one.

## Step-by-Step: How to Calculate Your Vehicle Deduction This Year

Here's a practical walkthrough for a sole proprietor using both methods to compare:

| | Standard Mileage | Actual Expense |
|---|---|---|
| Total miles driven | 18,000 | 18,000 |
| Business miles | 12,000 | 12,000 |
| Business-use % | 66.7% | 66.7% |
| Rate or total costs | IRS rate (check current) | $9,200 in total vehicle costs |
| Calculation | 12,000 x IRS rate | $9,200 x 66.7% |
| **Estimated deduction** | **Varies by rate** | **~$6,136** |

Run your own numbers. If your vehicle is expensive to operate or you're driving a high-value asset, actual expenses often win. If your car is reliable and cheap to run, standard mileage may come out ahead. Do both calculations before filing.

**Steps to take right now:**

1. Pull your odometer reading from January 1 and December 31 (or reconstruct as best you can from service records)
2. Categorize every trip you can recall or reconstruct as business or personal
3. Gather all vehicle receipts if you're considering actual expenses
4. Estimate your business-use percentage
5. Run both calculations or hand the numbers to your CPA
6. Choose your method and document your records for next year so you're not reconstructing anything
...
### Can I deduct a vehicle I use for both personal and business driving?

Yes, but only the business-use portion. You'll need to track your miles carefully and calculate the percentage of total driving that was for legitimate business purposes. If 60% of your miles were business-related, you can only deduct 60% of your expenses or 60% of your eligible mileage under either method.

### Do I need a separate vehicle titled in the business name to take a deduction?

No. A personally owned vehicle can qualify for business vehicle deductions as long as you can document the business use. However, if the business owns the vehicle, it should be titled in the business's name, and the business should carry appropriate commercial auto insurance.

### What happens if I'm audited and I don't have a mileage log?

The IRS can disallow the entire vehicle deduction. Courts have occasionally allowed reconstructed logs built from calendars, GPS records, and appointment books, but that's a stressful position to be in and the outcome isn't guaranteed. Keep contemporaneous records. It takes less time than you think if you use an app.

### Is there a limit on how expensive a vehicle can be for the deduction?

There are "luxury auto" caps that limit annual depreciation deductions for passenger vehicles above a certain cost threshold. Heavier vehicles (GVWR over 6,000 pounds) face different and generally more favorable rules. The caps change, so verify current limits with your CPA or the IRS website before making a vehicle purchase decision based primarily on tax benefits.

### Can I take a mileage deduction and also deduct my auto insurance?
