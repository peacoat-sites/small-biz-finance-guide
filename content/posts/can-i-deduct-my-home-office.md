---
title: "Home Office Deduction: Who Qualifies and How Much to Claim"
...
slug: "can-i-deduct-my-home-office"
affiliate_disclosure: true
faqs:
  - q: "Can I deduct my home office if I'm a full-time employee who works remotely?"
    a: "No. Under current federal law, W-2 employees cannot deduct home office expenses on their federal return. This restriction has been in place since the Tax Cuts and Jobs Act and, as of July 2026, Congress hasn't reversed it. Some states have different rules, so check your state return separately."
  - q: "Does my home office have to be a separate room?"
    a: "No, but it needs to be a clearly defined area used exclusively for business. A dedicated corner of a room with a visible boundary can qualify, but a shared space where personal and business activities happen is much harder to defend if you're audited. Separate rooms are cleaner."
  - q: "Which method gives me a bigger deduction?"
    a: "It depends on your space and costs, but the regular (actual expense) method typically wins for anyone paying significant rent or mortgage interest. Run both calculations before filing. The simplified method tops out at $1,500, which most real-world home offices beat with actual expenses."
  - q: "What if my business is profitable some years and not others?"
...
**Scenario 1: Freelance designer, renter, small apartment**
Office is 120 sq ft in a 750 sq ft apartment. Monthly rent: $1,800. Annual rent: $21,600. Office percentage: 16%.

Regular method: 16% of $21,600 = $3,456, plus utilities.
...
**Scenario 2: Consultant, homeowner, dedicated office room**
Office is 250 sq ft in a 2,500 sq ft home. Mortgage interest: $14,000/year. Utilities: $4,200. Insurance: $1,800. Depreciation (rough estimate): $2,100.

Office percentage: 10%.
Regular method: 10% × ($14,000 + $4,200 + $1,800 + $2,100) = 10% × $22,100 = $2,210.
Simplified method: 250 × $5 = $1,250.

Regular method wins again, by about $960.

**Scenario 3: Part-time side hustle, shared space issues**
Simplified method is your only practical option here, assuming the space even qualifies. When your records are thin and the exclusive-use standard is already a stretch, adding complexity makes an audit worse, not better.
...
For the regular method, you'll want twelve months of utility bills, your mortgage statement or lease, homeowner's insurance declarations page, and property tax bills if you own. The [U.S. Small Business Administration (SBA)](https://www.sba.gov/) has guidance on business recordkeeping standards that's worth reading once, not because it's thrilling, but because it tells you exactly what the government expects you to keep.

The IRS publishes Form 8829 for the regular method and its instructions are actually readable. The [Consumer Financial Protection Bureau's small business resources](https://www.consumerfinance.gov/) also point to tax basics for new self-employed folks, though for detailed deduction mechanics, IRS Publication 587 is the real reference document.
...
- [IRS Publication 587 (current year)](https://www.irs.gov/publications/p587): The authoritative IRS guide on business use of your home, covering exclusive use, regular use, calculation methods, and Form 8829.
- [IRS Form 8829 and Instructions](https://www.irs.gov/forms-pubs/about-form-8829): Required form for homeowners using the regular method; instructions contain depreciation calculation details.
- [U.S. Small Business Administration (SBA)](https://www.sba.gov/): Business recordkeeping standards and general guidance for self-employed individuals.
- [IRS Revenue Procedure 2013-13](https://www.irs.gov/irb/2013-06_IRB): The ruling that established the simplified method ($5/sq ft) as a legal alternative to actual expense calculation.
- [Tax Cuts and Jobs Act of 2017 (TCJA)](https://www.congress.gov/bill/115th-congress/house-bill/1): The legislation that suspended miscellaneous itemized deductions for employees, eliminating the W-2 employee home office deduction through at least 2025.
