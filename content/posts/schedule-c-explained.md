---
title: "Schedule C Explained: Self-Employment Tax & Deductions"
date: 2026-07-24T22:42:24.087063+00:00
draft: false
description: "Learn how Schedule C works for self-employed income, what deductions you can claim, and how it affects your taxes."
image: "/img/heroes/5077055.jpg"
categories: ["Taxes"]
tags: ["schedule", "explained"]
...
slug: "schedule-c-explained"
affiliate_disclosure: true
faqs:
  - q: "Do I need a separate bank account to file a Schedule C?"
    a: "The IRS doesn't require it, but I'd argue you're making your own life harder without one. Commingled personal and business transactions are the single biggest reason people miss deductions or overstate them. A dedicated business checking account, even a free one, makes your Schedule C defensible."
  - q: "What if I didn't track my expenses all year?"
    a: "You can reconstruct a lot from bank and credit card statements, but you'll miss cash purchases and anything you can't document. Go back through your records as carefully as you can, note what's provably business-related, and build a tracking system now so next year isn't the same scramble. A simple spreadsheet works. You don't need fancy software to start."
  - q: "Can I file a Schedule C if my business lost money?"
    a: "Yes. A net loss on your Schedule C generally flows to your 1040 and can offset other income, including W-2 wages. The exception is if the IRS reclassifies your activity as a hobby (no reasonable expectation of profit), in which case losses aren't deductible. Demonstrating you run it like a real business, keeping records, making improvements, advertising, matters."
  - q: "Do I need to file Schedule C if I only made a small amount of freelancing income?"
    a: "If your net self-employment income from the activity was $400 or more, you're required to file Schedule C and pay self-employment tax. Under $400 net, you still technically report the income, but you don't owe SE tax. There's no 'it's not worth reporting' threshold. Report it."
  - q: "Is a single-member LLC the same as a sole proprietor for Schedule C purposes?"
    a: "By default, yes. The IRS treats a single-member LLC as a 'disregarded entity,' meaning you file exactly the same as a sole proprietor: Schedule C on your personal 1040. If you've elected S-corp or C-corp taxation for your LLC, that's a different filing situation entirely, and you'll know if you did that because there was paperwork and a deliberate decision involved. When in doubt, confirm with a CPA, the classification matters a lot."
---
...
Schedule C is the IRS form where sole proprietors, freelancers, and single-member LLC owners report their [business income](/qualified-business-income-deduction/) and expenses. It flows directly into your personal Form 1040. One form, but it carries a lot of weight: it determines your taxable profit, which then drives your self-employment tax (currently 15.3% on net earnings up to $168,600 for 2026), and your income tax on top of that. Get it right and you're paying what you actually owe. Get it wrong and you're either overpaying or setting yourself up for a headache later.
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">Schedule C reports profit or loss from a sole proprietorship or single-member LLC on your Form 1040.</li><li style="margin:5px 0">Self-employment tax (15.3% on net earnings up to $168,600 in 2026) is calculated separately on Schedule SE, which flows from your Schedule C net profit.</li><li style="margin:5px 0">Deductible expenses reduce your taxable profit dollar-for-dollar, tracking them is not optional, it's the whole game.</li><li style="margin:5px 0">The home office deduction is real and legal; the simplified method allows $5 per square foot, up to 300 square feet.</li><li style="margin:5px 0">If your business lost money, that loss may offset other income on your 1040, but repeated losses trigger IRS scrutiny after three of five years.</li></ul></div>
...
Part II of Schedule C has 28 numbered lines covering specific [expense categories](/business-expense-categories-guide/). People tend to fill in the obvious ones (advertising, supplies) and ignore the ones that feel uncertain. That's a mistake.
...
| Expense | Schedule C Line | Common Mistake | Notes |
|---|---|---|---|
| Business mileage | Line 9 | Forgetting to log trips in real time | $0.70/mile (2026 IRS rate); requires mileage log |
| Home office | Line 30 | Overclaiming non-exclusive space | Must be regular and exclusive use |
| Health insurance premiums | Not on Sch. C | Putting it on Schedule C | Deducted as adjustment to income on Form 1040, not here |
| Meals (business) | Line 24b | Claiming 100% | Only 50% deductible; requires business purpose documented |
| Professional development | Line 27a | Skipping it entirely | Courses, books, coaching directly related to your current trade |
| Software subscriptions | Line 18 | Mixing personal/business | Only the business-use portion is deductible |
| Retirement contributions (SEP-IRA) | Not on Sch. C | Putting it on Schedule C | Goes on Form 1040 as an above-the-line deduction |

Health insurance and SEP-IRA contributions catch people every time. They feel like [business expenses](/what-business-expenses-are-tax-deductible/). They are not Schedule C deductions. They reduce your adjusted gross income on the 1040, which is still great, just in a different place.
...
**Scenario 3:** Side hustle selling handmade goods, $9,200 in sales, $11,500 in materials and fees. Net loss of $2,300. That loss flows to the 1040 and offsets her W-2 wages from her day job. Real money back. But: if this pattern continues three out of five years, the IRS may reclassify it as a hobby, disallowing future losses. The [U.S. Small Business Administration (SBA)](https://www.sba.gov/) has good guidance on how the hobby loss rules work in practice.
...
The one relief: you get to deduct half of your self-employment tax as an adjustment on your 1040. It doesn't eliminate the hit, but it softens it. The [Consumer Financial Protection Bureau's small business resources](https://www.consumerfinance.gov/) have a plain-language breakdown of how this works if you want to read it alongside IRS Publication 334.
...
- [IRS Schedule C Instructions (2025)](https://www.irs.gov/forms-pubs/about-schedule-c-form-1040): Official line-by-line instructions from the IRS, updated annually.
- [IRS Publication 334, Tax Guide for Small Business](https://www.irs.gov/pub/irs-pdf/p334.pdf): Comprehensive tax guide for sole proprietors; covers Schedule C in full context.
- [IRS Publication 587, Business Use of Your Home](https://www.irs.gov/pub/irs-pdf/p587.pdf): Definitive guidance on the home office deduction, including regular vs. simplified method.
- [U.S. Small Business Administration (SBA) -- Manage Your Finances](https://www.sba.gov/business-guide/manage-your-business/manage-your-finances): Plain-language resources on small business taxes and hobby loss rules.
- [IRS Revenue Procedure 2026-xx, Standard Mileage Rates](https://www.irs.gov/tax-professionals/standard-mileage-rates): IRS source for the current 2026 business mileage rate of $0.70/mile.
