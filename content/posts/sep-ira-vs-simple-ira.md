...
One thing worth knowing: the SIMPLE IRA has stricter eligibility rules around plan amendments and termination. You generally can't replace a SIMPLE IRA with another plan mid-year. The IRS [requires a two-year waiting period](https://www.irs.gov/retirement-plans/simple-ira-plan) before SIMPLE IRA funds can be rolled into a different plan type without penalty. That's not a deal-breaker, but it's the kind of detail that bites you if you're not aware of it going in.

## Setup and Ongoing Administration

Both plans are dramatically simpler than a 401(k). That's actually their main selling point compared to more complex retirement structures.
...
Generally, no. The IRS prohibits maintaining a SEP IRA in any year that you also maintain a SIMPLE IRA for the same employees. You'll need to choose one structure per plan year. Consult a CPA if you're mid-transition between plans.

#### Can I open a SEP IRA for a prior tax year?

Yes, and this is one of its best features. You can open and fund a SEP IRA for the prior year as late as your tax filing deadline, including any extensions. So if you file your return on extension in October, you can fund a prior-year SEP IRA in October.

#### What happens to my employees' SIMPLE IRA if I decide to terminate the plan?

Employees keep their vested balances, but they can't roll those funds into a traditional IRA or another plan without penalty until two years have passed since their first SIMPLE IRA contribution. After that two-year mark, the funds become fully portable.

#### Are SEP IRA contributions required every year?

No. One of the biggest advantages of a SEP IRA is that contributions are entirely discretionary. You can contribute the maximum in a profitable year and contribute nothing in a year where cash is tight. There's no commitment that carries over.

#### Who sets the investment options in a SEP or SIMPLE IRA?
