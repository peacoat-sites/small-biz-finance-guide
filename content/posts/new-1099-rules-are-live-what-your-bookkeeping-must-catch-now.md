---
title: "New 1099 Rules Are Live: What Your Bookkeeping Must Catch Now"
date: 2026-07-16T22:40:07.211325+00:00
draft: false
description: "New 1099 reporting rules are now in effect. Learn critical bookkeeping updates you must implement immediately to ensure compliance and avoid costly penalties."
image: "/img/heroes/8296974.jpg"
categories: ["trending"]
tags: ["1099", "rules", "live:", "what", "your"]
author: "Rachel Green"
...
I'll be honest: most of the small [business owners](/the-new-1099-thresholds-small-business-owners-must-know-in-2026/) I talk to right now are focused on capital spending. The NFIB Small Business Optimism Index hit 97.4 in June 2026, up 2.1 points, with 20% of owners planning capital outlays in the next six months. That's the highest reading of the year. Spending mode is great. But if you're bringing on new contractors or paying bonuses tied to overtime, this is exactly the moment your recordkeeping needs to be tightest.


<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">The 1099-NEC/MISC threshold rose to $2,000 on January 1, 2026, the first change since 1954.</li><li style="margin:5px 0">A 50-contractor list averaging $1,200/vendor could drop from 50 filings to roughly 15.</li><li style="margin:5px 0">Some states (Massachusetts, Vermont) still require 1099 filing at $600, creating a dual-threshold problem.</li><li style="margin:5px 0">New IRS occupation codes for qualified tips and overtime are required on 2026 W-2s, no more penalty relief.</li><li style="margin:5px 0">The 1099-K threshold is permanently back to $20,000 and 200 transactions.</li></ul></div>
...
Here's what surprised me when I went deep on this: the federal change doesn't automatically apply to your state obligations. According to analysis from Pease Bell published in June 2026, some states, including Massachusetts and Vermont, still require 1099 filing at the $600 threshold. If you have contractors in those states, you're operating under two different rules at the same time.

| Threshold Level | Who It Applies To | What You Must File |
| --- | --- | --- |
| $2,000 (federal) | All contractor payments, federal IRS | 1099-NEC or 1099-MISC to IRS |
| $600 (some states) | Contractors in states like MA, VT | State-level 1099 filing required |
| $20,000 + 200 transactions | Payment processors, 1099-K | 1099-K (permanently reset) |
...
- [The $600 1099 Rule Is Dead ,  New $2000 Threshold Explained](https://www.cfo.bot/blog/1099-reporting-threshold-2000-guide) (April 26, 2026)
- [1099 Threshold 2026: OBBBA Act Form 1099 Reporting Changes – Pease Bell](https://www.peasebell.com/insights/the-obbba-act-form-1099-reporting/) (June 2026)
- [1099 Reporting Thresholds 2026 New Filing Requirements | Tab Service](https://www.tabservice.com/blog/1099-reporting-thresholds-2026-when-new-filing-requirements-take-effect/) (June 11, 2026)
- [Preparing for OBBBA Payroll & Reporting Changes | Meaden & Moore](https://www.meadenmoore.com/blog/tax/preparing-for-obbba-payroll-reporting-changes-meaden-moore) (Late 2025 / updated 2026)
...
- [NEW NFIB SURVEY: Small Business Optimism Picks Up in June | NFIB](https://www.nfib.com/news/press-release/new-nfib-survey-small-business-optimism-picks-up-in-june/) (July 14, 2026)
