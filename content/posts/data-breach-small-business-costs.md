...
slug: "data-breach-small-business-costs"
affiliate_disclosure: true
faqs:
  - q: "Does my existing business insurance cover a data breach?"
    a: "Almost certainly not in full. Standard BOP policies exclude data breach response costs. You need a standalone cyber liability policy for meaningful coverage. Review your current policy's exclusions before assuming you're protected."
  - q: "How long does a small business have to notify customers after a breach?"
    a: "It depends on the state, but most require notification within 30 to 72 days of discovering the breach. Some states are faster. If you have customers in multiple states, you're subject to the strictest applicable rule. An attorney familiar with data privacy law should review your obligations immediately after an incident. Always consult a qualified attorney for guidance specific to your situation."
  - q: "What data types trigger the most serious consequences?"
    a: "Social Security numbers, financial account numbers, medical records, and login credentials consistently generate the highest regulatory and legal exposure. Breaches involving these categories almost always require formal notification and carry the most significant fine risk."
  - q: "Can a small business negotiate regulatory fines down?"
...
Scenario → 40 clients notified, all operations halted for 11 days while forensics ran → $72,000 spent in first 30 days, 3 clients terminated contracts (representing about $190,000 in annual revenue).
...
Scenario → Proactive MFA enforcement → Credential-stuffing attempt blocked, $0 breach cost vs. estimated $85,000-$200,000 exposure.
...
- [IRS Small Business Tax Center](https://www.irs.gov/businesses/small-businesses-self-employed): Official IRS resource for small business compliance, relevant for businesses handling tax data or operating as financial service providers.
- [Consumer Financial Protection Bureau Small Business Resources](https://www.consumerfinance.gov/): Federal guidance on financial data handling obligations for small businesses.
