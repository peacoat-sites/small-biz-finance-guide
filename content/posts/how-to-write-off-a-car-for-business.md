---
title: "How to Write Off Your Car as a Business Expense"
date: 2026-07-08T22:43:42.488494+00:00
draft: false
...
slug: "how-to-write-off-a-car-for-business"
affiliate_disclosure: true
faqs:
  - q: "Can I write off a car I already own or does it have to be a new purchase?"
    a: "Yes, you can deduct business use of a vehicle you already own. The standard mileage method works regardless of when you bought the car. If you want to use actual expenses and depreciation, you'll start depreciating it based on its fair market value when you first placed it in business service, not the original purchase price."
  - q: "What if I use my car for both personal and business use?"
    a: "That's completely normal and doesn't disqualify the deduction. You simply deduct the business-use percentage only. If you drive 15,000 miles total and 9,000 are for business, your business-use percentage is 60%, and you apply that to either your mileage calculation or your actual expense total."
  - q: "Does my vehicle need to be in the business's name to deduct it?"
    a: "No. Many sole proprietors and single-member LLC owners use a personally titled vehicle for business and deduct it just fine. The key is documentation of business use and keeping personal versus business use separate in your records. That said, there can be liability and insurance reasons to title a vehicle in a business name, which is a separate conversation worth having with your attorney."
  - q: "What's the cleanest way to handle a vehicle if I'm an S-Corp owner?"
    a: "This gets nuanced fast, and I'll be honest: it's one of the areas where a CPA is worth every dollar. The most common approach is for the S-Corp to reimburse you for business miles under an accountable plan, which keeps the reimbursement off your W-2. If the S-Corp owns the vehicle outright, different rules apply and fringe benefit reporting gets involved. Get professional advice here rather than winging it."
  - q: "If I took the standard mileage rate last year, can I switch to actual expenses this year?"
    a: "Generally yes, you can switch from standard mileage to actual expenses in a later year. But once you've used the actual expense method with MACRS depreciation on a vehicle, you can't switch back to standard mileage for that same vehicle. The direction you can't go is backward, which is why I always recommend running both calculations before you file that first-year return."
---
...
As of 2026, the IRS standard mileage rate sits at 70 cents per mile for business driving (confirm the current rate at the [IRS small business tax center](https://www.irs.gov/businesses/small-businesses-self-employed) since Congress adjusts this periodically). That sounds simple, and it is. You log your miles, multiply, deduct. Done.
...
**Scenario:** Maria runs a mobile dog grooming business in Phoenix. She buys a used 2023 Ford Transit (GVWR 8,550 lbs) for $42,000 in January. She uses it 95% for business.
**Action taken:** Her CPA elects Section 179 on the qualifying portion.
**Result:** She deducts $39,900 (95% of $42,000) in Year 1 instead of spreading depreciation over five years. At a 25% effective tax rate, that's roughly $9,975 in tax savings in Year 1 rather than $1,500 to $2,000 per year over five years. Cash flow difference: significant.
...
**Scenario:** David is a real estate agent in Atlanta who drives roughly 22,000 miles per year, about 85% for business. He's deciding between buying a $38,000 sedan or leasing it at $549/month.
**Action taken:** He runs both scenarios with his accountant. Under the standard mileage rate on a purchased vehicle, his deduction is approximately $13,090/year (18,700 business miles x $0.70). Under the lease method, his deductible lease cost is roughly $5,598/year (85% of $6,588 in annual payments) plus deductible actual expenses for gas, insurance, and repairs attributable to business use.
**Result:** The standard mileage rate came out significantly ahead for David because his per-mile deduction rate is high and his actual vehicle costs aren't exceptional. He buys, uses standard mileage, and keeps a clean MileIQ log. Done.
...
But a legitimate, documented vehicle deduction taken by a business that actually uses that vehicle for business is not a red flag. The [Consumer Financial Protection Bureau's small business resources](https://www.consumerfinance.gov/) and various IRS guidance consistently emphasize that proper documentation is the real protection, not timidity about taking deductions you've earned.
...
If you want to go deeper on the tax mechanics, *J.K. Lasser's Small Business Taxes* (available on [Amazon](https://www.amazon.com/s?k=JK+Lasser+Small+Business+Taxes), note the site may earn a commission) is updated annually and genuinely useful without requiring a CPA credential to understand.

## Sources

- [IRS Publication 463 (Travel, Gift, and Car Expenses)](https://www.irs.gov/pub/irs-pdf/p463.pdf): Official IRS guidance on vehicle deductions, mileage rates, and recordkeeping requirements
- [IRS Publication 946 (How to Depreciate Property)](https://www.irs.gov/pub/irs-pdf/p946.pdf): Section 179 limits, bonus depreciation rules, and MACRS schedules for vehicles
- [IRS Small Business Tax Center](https://www.irs.gov/businesses/small-businesses-self-employed): Current mileage rates, tax updates, and small business resources
- [IRS Revenue Procedure 2025-X (Luxury Auto Caps)](https://www.irs.gov/businesses/small-businesses-self-employed): Annual inflation adjustments for listed property depreciation limits
- [Consumer Financial Protection Bureau Small Business Resources](https://www.consumerfinance.gov/): Guidance on financial recordkeeping practices for small business owners
